...
namespace YarnDonut
{
	...
	/// </summary>
	[Tool]
	public partial class YarnDonutPlugin : EditorPlugin
	{
		...
		public override void _EnterTree()
		{
			...
			// load icons
			var miniLocalizationIcon = ResourceLoader.Load<Texture2D>("res://addons/YarnDonut/Editor/Icons/Asset Icons/mini_Localization Icon.png");
			var miniYarnSpinnerIcon = ResourceLoader.Load<Texture2D>("res://addons/YarnDonut/Editor/Icons/mini_YarnSpinnerLogo.png");
			var miniYarnProjectIcon = ResourceLoader.Load<Texture2D>("res://addons/YarnDonut/Editor/Icons/Asset Icons/mini_YarnProject Icon.png");
